...
(function ($) {
    ...
    if ($("body").not(".is-mobile").hasClass("tv-magic-cursor")) {
        $(".tv-magnetic-item").wrap('<div class="tv-magnetic-wrap"></div>');

        if ($("a.tv-magnetic-item").length) {
            $("a.tv-magnetic-item").addClass("not-hide-cursor");
        }
        ...
        $(".tv-magnetic-wrap").on("mousemove", function (e) {
            parallaxCursor(e, this, 2); // magnetic ball = low number is more attractive
            callParallax(e, this);
        });

        function callParallax(e, parent) {
            parallaxIt(e, parent, parent.querySelector(".tv-magnetic-item"), 25); // magnetic area = higher number is more attractive
        }
        ...
        // Magnetic item hover.
        $(".tv-magnetic-wrap").on("mouseenter", function (e) {
            gsap.to($ball, { duration: 0.3, scale: 2, borderWidth: 1, opacity: $ballOpacity });
            $active = true;
        }).on("mouseleave", function (e) {
            gsap.to($ball, { duration: 0.3, scale: $ballScale, borderWidth: $ballBorderWidth, opacity: $ballOpacity });
            gsap.to(this.querySelector(".tv-magnetic-item"), { duration: 0.3, x: 0, y: 0, clearProps: "all" });
            $active = false;
        });
        ...
        $("a")
            ...
            .not(".tv-btn-disabled a") // omit from selection.
            .on('click', function () {
